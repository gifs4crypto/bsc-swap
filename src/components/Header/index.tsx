...
import Logo from '../../assets/images/kong_inu.png'
...
const Nav: React.FC = () => {
  return (
    <StyledNav>
      <StyledAbsoluteLink href="https://google.com" target="_blank" >Kong Inu Swap Utility</StyledAbsoluteLink>
      {/* <StyledAbsoluteLink href="" className="active">Some link</StyledAbsoluteLink>
      <StyledAbsoluteLink href="https://bscswap.info" target="_blank">Some link</StyledAbsoluteLink> */}
      ...
      {/* <StyledAbsoluteLink href="https://www.google.com" target="_blank">Some link</StyledAbsoluteLink>
      <StyledAbsoluteLink href="https://www.google.com" target="_blank">Some link</StyledAbsoluteLink> */}
    </StyledNav>
  )
}
    ...
    <HeaderFrame>
      <RowBetween style={{ alignItems: 'flex-start'}} padding="1rem 1rem 0 1rem" >
        <HeaderElement>
          <Title href=".">
            <UniIcon>
              <img style={{ height: 200, width:200, marginTop:-10 }} src={isDark ? LogoDark : Logo} alt="logo" />
            </UniIcon>
          </Title>
        </HeaderElement>
        <Nav />
